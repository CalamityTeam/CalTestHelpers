	...
	public class ProjectileStatEditUIRenderer : GrandUIRenderer
	{
		...
		public override void DrawElements(SpriteBatch spriteBatch, float top)
		{
			...
			foreach (int projectileType in projectileTypes)
			{
				...
				Texture2D projectileTexture = TextureAssets.Projectile[projectileType].Value;
				...
				Rectangle projectileFrame = projectileTexture.Frame(1, totalFrames, 0, (int)(Main.GlobalTimeWrappedHourly * 6.6f % totalFrames));
		...
		public void ResetProjectileStats()
		{
			...
			EntityOverrideCache.LocalIFrameOverrides[projectileType] = ProjectileBeingEdited.localNPCHitCooldown;
			EntityOverrideCache.StaticIFrameOverrides[projectileType] = ProjectileBeingEdited.idStaticNPCHitCooldown;
